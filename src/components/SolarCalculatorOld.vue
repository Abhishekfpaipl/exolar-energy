                        ...
                        <div class="container">
                            <form @submit.prevent="">
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    <label for="Your Phone No">Your Phone No.</label>
                                </div>
                                <div class="form-floating mb-3">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="card d-flex flex-column align-items-center text-center p-3 h-100"
                                            ...
                                            <p class="text-center mb-1 smaller" style="min-height:48px">Annual Energy
                                                Produced</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="card d-flex flex-column align-items-center text-center p-3 h-100"
                                            ...
                                            <p class="text-center mb-1 smaller" style="min-height:48px">CO2 Offset
                                                kg/per year</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="card d-flex flex-column align-items-center text-center p-3 h-100"
                                            style="background-color: #f3f8f3 !important;">
                                            <img src="/img/tree-save.svg" style="width: 35px; height: 35px;"
                                                class="mb-3"
                                                alt="Rooftop solar panel installation in Delhi by Exolar Energy">
                                            <p class="text-center mb-1 fs-4 ">{{ treeSaved }}</p>
                                            <p class="text-center mb-1 smaller" style="min-height:48px">Tree saved per
                                                year</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="card d-flex flex-column align-items-center text-center p-3 h-100"
                                            ...
                                            <p class="text-center mb-1 smaller" style="min-height:48px">Car Miles
                                                Avoided per year</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div v-if="kWH !== null" class="row justify-content-center  align-items-center">
